class system_pkt;
  ...
  // Mutually exclusive Cin constraints — caller enables exactly one
  constraint Cin_C_0 { Cin == 1'b0; }
  constraint Cin_C_1 { Cin == 1'b1; }
  ...
  covergroup cg;
    ...
    cp_Cin: coverpoint Cin {
      ...
      ignore_bins Cin_ONE_T_ZERO = (1'b1 => 1'b0);
    }
